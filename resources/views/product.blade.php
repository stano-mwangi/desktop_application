...
<div class="container-fluid">
    ...
    <li><a href="#"><i class="fas fa-plus-circle text-success"></i> New Product</a></li>
    <li>
                    <!-- Search Bar -->
                    <input type="text" class="form-control mt-3" id="search-product" placeholder="Search product by Name/UPC">
                </li>
</ul>
